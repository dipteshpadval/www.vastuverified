...
const PropertyListings: React.FC = () => {
  ...
  useEffect(() => {
    // Initialize with mock data if no properties loaded
  ...
  const properties = state.filteredProperties.length > 0 ? state.filteredProperties : mockProperties
                ...
                >
                  ...
                  <div className={`p-6 ${viewMode === 'list' ? 'flex-1' : ''}`}>
                    ...
                    <div className="mb-4">
                      ...
                      {/* Price */}
                      <div className={`rounded-xl p-4 mb-4 shadow-md hover:shadow-lg transition-all duration-300 ${
                        ...
                        <div className={`text-sm font-medium ${
                          ...
                          {property.transactionType === 'rent' && '/sqft'}
                        </div>
                      </div>
                    </div>
