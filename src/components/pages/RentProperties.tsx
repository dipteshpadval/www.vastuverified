...
const RentProperties: React.FC = () => {
  ...
  // Filter properties for rent transaction type
  const rentProperties = mockProperties.filter(property => property.transactionType === 'rent')
  ...
  useEffect(() => {
    ...
    const initialFilters = {
      ...
      transactionType: 'rent' as 'buy' | 'rent' | 'sell',
    }
  ...
  const properties = state.filteredProperties.length > 0 ? state.filteredProperties : rentProperties
  ...
  const applyFilters = () => {
    searchProperties({ ...filters, transactionType: 'rent' })
  ...
  const clearFilters = () => {
    ...
    searchProperties({ transactionType: 'rent' })
  }
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Find your perfect rental home from our extensive collection</p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-soft p-6 sticky top-24">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {priceRanges.rent.map((range, index) => (
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <label key={furnishing.value} className="flex items-center">
                        <input
                          type="checkbox"
                          className="rounded border-gray-300 text-primary-600 focus:ring-primary-500"
                        />
                        <span className="ml-2 text-sm text-gray-700">{furnishing.label}</span>
                      </label>
                    ))}
                  </div>
                </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">
                    {properties.length} Properties for Rent
                ...
                >
                  ...
                  <div className={`p-6 ${viewMode === 'list' ? 'flex-1' : ''}`}>
                    ...
                    <div className="mb-4">
                      ...
                      {/* Price */}
                      <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl p-4 mb-4 shadow-md hover:shadow-lg transition-all duration-300 hover:border-green-300">
                        <div className="text-2xl font-bold text-green-900 mb-1">
                          {formatCurrency(property.price)}/month
                        </div>
                        <div className="text-sm text-green-700 font-medium">
                          {formatPricePerSqft(property.price, property.area)}/sqft
                        </div>
                      </div>
                    </div>
