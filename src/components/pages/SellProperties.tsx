...
const SellProperties: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const initialFilters = {
      ...
      transactionType: 'sell' as 'buy' | 'rent' | 'sell',
    }
  ...
  const applyFilters = () => {
    searchProperties({ ...filters, transactionType: 'sell' })
  ...
  const clearFilters = () => {
    ...
    searchProperties({ transactionType: 'sell' })
  }
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Sell your property or find properties listed by owners</p>
            </div>
          </div>
        </div>
                ...
                >
                  ...
                  <div className={`p-6 ${viewMode === 'list' ? 'flex-1' : ''}`}>
                    ...
                    <div className="mb-4">
                      ...
                      {/* Price */}
                      <div className="bg-gradient-to-r from-purple-50 to-pink-50 border-2 border-purple-200 rounded-xl p-4 mb-4 shadow-md hover:shadow-lg transition-all duration-300 hover:border-purple-300">
